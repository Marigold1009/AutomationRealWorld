...
public class ApiReportListener implements ITestListener {
    private static final Logger logger = LogManager.getLogger(ApiReportListener.class);
    ...
    public void onTestFailure(ITestResult result) {
        ...
        if (test != null) {
            ...
            String logs = LogFactory.getWriter() != null ? LogFactory.getWriter().toString() : "No captured logs.";
