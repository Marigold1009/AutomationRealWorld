...
public class LoginTestSuite {
  ...
  public void beforeMethod(ITestResult result) {
    ...
    if (Arrays.asList(groupName).contains("from_singup_page")
        || Arrays.asList(groupName).contains("from_detaied_article")) {
      return;
    } else {
  ...
  public void TC1_Login_Success() {
    ...
    //        loginSteps.loginWith(ConfigLoader.getValue("test.email"),
    // ConfigLoader.getValue("test.password"));
    //        Assert.assertTrue(true);
  }

  @Test(
      description = "Login Fail_Wrong Email",
      groups = {"valid_user"})
  ...
  @Test(
      description = "Login Fail_Wrong Paasword",
      groups = {"valid_user"})
  ...
  @Test(
      description = "Login_Fail_Wrong Email and Password",
      groups = {"valid_user"})
  ...
  @Test(
      description = "Login Fail_Empty Password",
      groups = {"valid user"})
  ...
  @Test(
      description = "Login Fail_Empty Email",
      groups = {"valid_user"})
  ...
  @Test(
      description = "Login Fail_Empty Email and Password",
      groups = {"valid_user"})
